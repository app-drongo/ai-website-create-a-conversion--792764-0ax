...
export default function Cta1() {
  const stats = [
    { value: "10K+", label: "Games Available", icon: Gamepad2 },
    { value: "500K+", label: "Active Gamers", icon: Users },
    { value: "24/7", label: "Gaming Support", icon: Trophy },
    { value: "Fast", label: "Digital Delivery", icon: ShoppingCart }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                GameVerse has everything you need to dominate your gaming sessions.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Official partner with top gaming publishers
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Publisher logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div 
                      key={i} 
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Earn points with every purchase for exclusive discounts
              </p>
            </div>
          </div>
        </div>
