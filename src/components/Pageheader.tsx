      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Explore our massive collection of the latest video games, premium gaming accessories, 
            and cutting-edge hardware. From AAA blockbusters to indie gems, find everything you need 
            to dominate your gaming sessions at GameVerse.
          </p>
        </div>
      </div>
    </section>
