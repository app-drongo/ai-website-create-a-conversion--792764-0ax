...
import { ArrowRight, Gamepad2, Users, Trophy, ShoppingCart } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "100K+", label: "Active Gamers", icon: Users },
    { value: "50K+", label: "Games Available", icon: Gamepad2 },
    { value: "1M+", label: "Orders Delivered", icon: ShoppingCart },
    { value: "24/7", label: "Gaming Support", icon: Trophy }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the ultimate gaming community at GameVerse. Discover the latest games, 
                exclusive deals, and premium gaming hardware all in one place.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by gamers worldwide and official partner of top gaming brands
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Gaming brand logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div 
                      key={i} 
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Gamer Rewards</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Digital games delivered instantly to your library
              </p>
            </div>
          </div>
        </div>
